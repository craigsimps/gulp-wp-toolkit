...
module.exports = {
    ...
    'lint:js': [['lint:jshint', 'lint:jscs', 'lint:jsvalidate', 'lint:json']],
    'lint:i18n': [require('./lint/i18n')],
    'lint:colors': [require('./lint/colors')],
    'lint': [['lint:scss', 'lint:js', 'lint:i18n', 'lint:colors']],
    ...
    'self': [['self:jshint', 'self:jscs', 'self:jsvalidate', 'self:json']],
